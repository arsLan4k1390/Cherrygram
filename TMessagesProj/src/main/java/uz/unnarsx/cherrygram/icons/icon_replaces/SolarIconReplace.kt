...
import uz.unnarsx.cherrygram.icons.newSparseInt
...
class SolarIconReplace : BaseIconReplace() {
    override val replaces: SparseIntArray = newSparseInt(
            ...
            R.drawable.msg_storage_path to R.drawable.sd_card,
            // Logout activity
            ...
            R.drawable.msg_view_file to R.drawable.eye, // Cache settings
