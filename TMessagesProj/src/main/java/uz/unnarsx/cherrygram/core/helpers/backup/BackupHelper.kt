...
object BackupHelper {
    ...
    private fun backupSettingsJson(context: Context): String {
        ...
        val keys = setOf(
            ...
            "CP_ShowForward_WO_Authorship", "CP_ShowViewHistory", "CP_ShowSaveMessage", "CP_ShowReport", "CP_ShowJSON", "CP_JacksonJSON_Provider",
            ...
            "CP_TimeOnStick", "CP_ForwardMsgDate", "AP_PencilIcon",
