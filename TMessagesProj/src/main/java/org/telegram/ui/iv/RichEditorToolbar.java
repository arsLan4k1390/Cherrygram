...
public class RichEditorToolbar extends FrameLayout {
    ...
    public RichEditorToolbar(Context context, Delegate delegate) {
        ...
        addView(bottomContainer, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL, 0, 0, 0, DialogsActivity.MAIN_TABS_MARGIN));
