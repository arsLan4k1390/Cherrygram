...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final int VIEW_TYPE_SHADOW = 1390;
...
//    private int forceCleanRow;
    ...
    private int kaboomButtonDivisor;
...
//        itemInners.add(new ItemInner(VIEW_TYPE_INFO, "cache", null));
        ...
        itemInners.add(new ItemInner(VIEW_TYPE_TEXT_SETTINGS, null, null));
        kaboomButton = itemInners.size();
        itemInners.add(new ItemInner(VIEW_TYPE_TEXT_SETTINGS, null, null));
        kaboomButtonDivisor = itemInners.size();
        itemInners.add(new ItemInner(VIEW_TYPE_SHADOW, null, null));
...
//                    }
    ...
    private void forceClean(Context context) {
        ...
        builder.setTitle(LocaleController.getString("CG_ForceClean", R.string.CG_ForceClean));
        builder.setMessage(LocaleController.getString("CG_ForceCleanInfo1", R.string.CG_ForceCleanInfo1));
    ...
    private void clearDatabase() {
        ...
        builder.setMessage(LocaleController.getString("LocalDatabaseInfo", R.string.LocalDatabaseInfo) + "\n" + "\n" + LocaleController.getString("LocalDatabaseClearText", R.string.LocalDatabaseClearText));
        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    private class ListAdapter extends AdapterWithDiffUtils {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == migrateOldFolderRow/* || position == forceCleanRow*/ || position == databaseRow || position == kaboomButton || (holder.getItemViewType() == VIEW_TYPE_STORAGE && (totalSize > 0) && !calculating) || holder.getItemViewType() == VIEW_TYPE_CHAT;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_TEXT_SETTINGS:
                    ...
                    /*if (position == forceCleanRow) {
                        textCell.setCanDisable(false);
                        textCell.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteRedText));
                        textCell.setText(LocaleController.getString("CG_ForceClean", R.string.CG_ForceClean), true);
                    } else*/ if (position == databaseRow) {
                        textCell.setTextAndValue(LocaleController.getString("ClearLocalDatabase", R.string.ClearLocalDatabase), AndroidUtilities.formatFileSize(databaseSize), updateDatabaseSize, true);
