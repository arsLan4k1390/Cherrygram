...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin, boolean needAddButton, boolean needMutualIcon) {
        ...
        if (CherrygramConfig.INSTANCE.getMutualContacts())
            if (needMutualIcon) {
                ...
                mutualView.setContentDescription(LocaleController.getString("AP_MutualContacts", R.string.AP_MutualContacts));
        ...
        if (CherrygramConfig.INSTANCE.getMutualContacts())
            if (mutualView != null) {
                ...
                if (currentUser != null && currentUser.mutual_contact) {
                    nameTextView.setContentDescription(nameTextView.getText() + " (" + LocaleController.getString("AP_MutualContacts", R.string.AP_MutualContacts) + ")");
                }
            }
    }
