...
public class ActionBarLayout extends FrameLayout {
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        public boolean dispatchTouchEvent(MotionEvent ev) {
            boolean previewModeStatus = !CherrygramConfig.INSTANCE.getScrollableChatPreview() && inPreviewMode;
            ...
            if (CherrygramConfig.INSTANCE.getScrollableChatPreview() && inPreviewMode && previewMenu == null) {
