...
public class TL_keyboard {
    ...
    public interface KeyboardButtonProto {
        ...
        public default long getUserID() {
            final ButtonTypeProto type = getType();
            if (type instanceof TL_inlineButtonTypeUserProfile) {
                return ((TL_inlineButtonTypeUserProfile) type).user_id;
            }
        ...
        public default String getQuery() {
            final ButtonTypeProto type = getType();
            if (type instanceof TL_inlineButtonTypeSwitchInline) {
                return ((TL_inlineButtonTypeSwitchInline) type).query;
            }
