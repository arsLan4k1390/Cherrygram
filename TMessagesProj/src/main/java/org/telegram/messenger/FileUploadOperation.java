...
public class FileUploadOperation {
    ...
    public void start() {
        ...
        Utilities.stageQueue.postRunnable(() -> {
            ...
            slowNetwork = CherrygramCoreConfig.INSTANCE.getSlowNetworkMode();
...
//                }
                ...
                uploadChunkSize = (int) Math.max(slowNetwork ? minUploadChunkSlowNetworkSize : CherrygramCoreConfig.INSTANCE.getUploadSpeedBoost() ? minUploadChunkSizeBoost : minUploadChunkSize, (totalFileSize + 1024L * maxUploadParts - 1) / (1024L * maxUploadParts));
