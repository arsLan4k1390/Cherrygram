...
public class MessagesStorage extends BaseController {
    ...
    public static void createTables(SQLiteDatabase database) throws SQLiteException {
        ...
        database.executeFast("CREATE TABLE dialog_filter_cherry(id INTEGER PRIMARY KEY, ord INTEGER, unread_count INTEGER, flags INTEGER, title TEXT, color INTEGER DEFAULT -1, emoticon TEXT)").stepThis().dispose();
    ...
    private void loadDialogFilters() {
        storageQueue.postRunnable(() -> {
            ...
            try {
                ...
                filtersCursor = database.queryFinalized("SELECT id, ord, unread_count, flags, title, color, emoticon FROM dialog_filter_cherry WHERE 1");
